...
const THEME_DEFINITIONS = [
  {
    id: "monochrome",
    name: "Black & White",
    description: "A focused dark appearance with black surfaces, white text, and grayscale controls.",
  ...
  },
  {
    id: "white-purple",
    name: "White & Purple",
    description: "A polished white workspace with purple focus accents for modern coding study.",
    swatches: ["#ffffff", "#f6f1ff", "#7040e8"],
    tokens: {
      background: "#fbfaff",
      surface: "#ffffff",
      surfaceElevated: "#f6f1ff",
      border: "#d9c8f5",
      textPrimary: "#211a35",
      textSecondary: "#42375b",
      textMuted: "#5f5672",
      accent: "#7040e8",
      accentHover: "#5b2bd6",
      accentText: "#ffffff",
      ...
      inputBackground: "#ffffff",
      inputBorder: "#cbb7ed",
      buttonBackground: "#7040e8",
      buttonText: "#ffffff",
      codeBackground: "#1a152b",
      codeText: "#f1ebff",
    },
  },
  {
