...
function AdminDashboard({ user, onBack }) {
  ...
  const filteredCourses = useMemo(() => {
    ...
    return courses.filter((course) => `${course.title} ${course.category} ${course.id}`.toLowerCase().includes(query));
